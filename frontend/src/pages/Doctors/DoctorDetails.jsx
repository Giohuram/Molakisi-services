       ...
       <div className="max-w-[1170px] px-5 mx-auto">
          <div className="grid md:grid-cols-3 gap-[50px]">
            ...
            <div>
              ...
              <h3 className="text-headingColor text-[22px] leading-9 mt-3 font-bold">Muhir Rahman</h3>
              ...
              <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda inventore accusamus dolore in iusto quae tenetur?
              </p>
            </div>
            <div>
              <SidePanel />
