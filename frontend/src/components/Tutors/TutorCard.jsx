    ...
    return (
        <div className='p-3 lg:p-5'>
            <div className='tutor-image-container'>
                <img src={photo} className='tutor-image' alt={`${name}'s photo`} />   
            </div>   
            ...
            <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
                ...
                <Link to={`/tutors/${tutor._id}`} className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
