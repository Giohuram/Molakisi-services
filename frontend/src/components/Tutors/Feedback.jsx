...
//             {showFeedbackForm ? "Hide Feedback Form" : "Donner votre"}
//           </button>
//         </div>
...
const Feedback = ({ reviews, totalRating, onReviewSubmitted }) => {
  ...
  const handleReviewSubmitted = () => {
    ...
    onReviewSubmitted();
    setLoading(false);
    toast.success('Review submitted successfully!'); // Notify on successful submission
  };
  ...
  return (
    <div>
      <div className="mb-[50px]">
        ...
        <div className='text-center'>
          <button className="btn" onClick={() => setShowFeedbackForm(!showFeedbackForm)}>
            {showFeedbackForm ? "Hide Feedback Form" : "Donner votre feedback"}
          </button>
        </div>
